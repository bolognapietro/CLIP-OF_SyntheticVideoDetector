...
if __name__ == '__main__':
    # Set the category type to analyze
    ...
    for i, (name, value) in enumerate(zip(data["filename"], data["prediction"])):
    ...
    accuracy = compute_accuracy(data_filtered, grouped_labels_filtered)

    # Set plot parameters
    ranges, x_ticks, x_positions = set_plot_params(grouped_labels_filtered, accuracy)

    # Plot the graph
    plot_graph(data_filtered, ranges, x_ticks, x_positions, f"CLIP results category {CATEGORY_TYPE}") # {selected_column}